...
<div className='Checkbox'>
    <div>
<h3 style={{fontSize:25}}>Categories</h3>
<FormGroup>
      <FormControlLabel control={<Checkbox />} label="Chill oil; Okazu" />
      <FormControlLabel control={<Checkbox />} label="Miso Soup" />
      <FormControlLabel control={<Checkbox />} label="Instant Masala" />
      <FormControlLabel control={<Checkbox />} label="Coffee" />
      <FormControlLabel control={<Checkbox />} label="Greeting Card" />
      <FormControlLabel control={<Checkbox />} label="Coming Soon" />
    </FormGroup>
    </div>
    <div style={{marginLeft:120}}>
    <h3 style={{fontSize:25}}>Types</h3>
<FormGroup>
      <FormControlLabel control={<Checkbox />} label="Single Pack" />
      <FormControlLabel control={<Checkbox />} label="Multi Set" />
    </FormGroup>
    </div>
    <div style={{marginLeft:120}}>
    <h3 style={{fontSize:25}}>Flavours</h3>
 </div>
</div>
